  ...
  return (
    <View className="bg-black flex-1 justify-start items-center relative">
      ...
      <View className="flex flex-row absolute items-left left-8 top-11">
        ...
        {/* OtherUserProfile */}
        <TouchableOpacity onPress={() => navigation.navigate("OtherUserProfileView", { userId: sender?._id })}>
          <View className="w-[160] justify-center items-left top-[10]">
      ...
      {/* View to display the input field to send messages or accept or disconnect to the text request */}
      {
        ...
        !conversation?.acceptedBy?.includes(userInfo._id) ? (
          ...
          <View className="w-full flex flex-row justify-center items-center">
            <View className="flex flex-row justify-center items-center relative w-[380]">
              {/* If the user message count is less than 10, the user can send messages */}
              {userMessageCount < 10 ? (
                <>
                  <TouchableOpacity
                ...
                <Text className="text-gray-500 text-base">
                  You have reached the limit of 10 messages for this
                  conversation. Please wait for the count to reset after 45
                  mins.
                </Text>
              )}
            </View>
