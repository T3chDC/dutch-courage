import {
  ...
  const OtherUserProfileView = ({ route }) => {
    // Navigation hook
      ...
      <View className='bg-black flex-1 justify-start items-center relative'>
        ...
        {isOtherGetLoading ? (
          ...
          <>
            ...
            {/* User Name */}
            <View className='mt-4 mb-4 w-[100vw] flex-row justify-center items-center'>
              <Text className='text-white text-4xl font-medium'>{userName}</Text>
            </View>
  
            {/* Mantra */}
            <View className='mt-1 mb-2 w-[100vw] flex-row justify-center items-center'>
              <Text className='text-white text-2xl font-medium'>{mantra}</Text>
            </View>
            ...
            <View className='mt-1 mb-2 w-[100vw] flex-row justify-center items-center'>
              <Text className='text-white text-xl font-normal'>
                {topInterests.map((interest, idx) => (
                  <Text key={idx} className='text-white text-xl font-normal'>
                    {' '}
